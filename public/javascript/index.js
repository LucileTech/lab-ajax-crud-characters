...
document
  ...
  .addEventListener("submit", async function (event) {
    ...
    character.name = document.getElementById("edit-name").value;
    character.occupation = document.getElementById("edit-occupation").value;
    character.weapon = document.getElementById("edit-weapon").value;
    character.cartoon = document.getElementById("edit-cartoon").value;
